	...
	<div id="wrapper">
		...
		<div id="sidebar-wrapper">
			<ul class="sidebar-nav">
				...
				<li><a href="/SpringMvcPojoHb/ProductList"><img
						src="/SpringMvcPojoHb/images/list.png" />Product List</a></li>
		...
		<div id="page-content-wrapper">
			...
			<div class="rightcolumn">
				...
				<form:form action="/SpringMvcPojoHb/ProductUpdate" method="post"
					commandName="product">
					<table
...
<form:option value="Developer" label="Developer"/>
					...
					<input type="button" class="btn btn-default" value="List"
						onclick="location.href='/SpringMvcPojoHb/ProductList'" style="float: right">
