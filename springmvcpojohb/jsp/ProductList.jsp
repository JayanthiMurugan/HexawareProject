		...
		<div id="page-content-wrapper">
			<div class="container-fluid">
				...
				<div>
					...
					<form:form action="/SpringMvcPojoHb/ProductDelete" method="post" commandName="productForm">
					<table
						...
						<tr>
							<td><a href="/SpringMvcPojoHb/ProductEdit?id=${product.productid}">${product.productid}</a>
